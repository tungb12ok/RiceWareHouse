        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Export Rice</h1>

                    <!-- Search Form: Customer ID Verification -->
                    <form method="get" action="ExportRiceController" class="row g-3 mb-4">
                        <div class="col-md-4">
                    ...
                    <c:if test="${not empty customer}">
                        ...
                        <!-- Export Rice Form -->
                        <form action="ExportRiceController" method="post">
                            ...
                            <button type="submit" class="btn btn-primary mt-3">Export Rice</button>
                        </form>
                    </c:if>
                </div>
            </main>
